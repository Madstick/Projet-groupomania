...
module.exports = (req, res, next) => {
  try {
    ...
    const userId = decodedToken.userId // transformé en objet Javascript qu'on place dans une constante, et on y récupère l'user ID pour comparaison le cas échéant
